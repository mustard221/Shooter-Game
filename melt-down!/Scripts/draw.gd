...
func _draw() -> void:
	...
	draw_rect(Rect2(pos, rect_size), colour, true)
	draw_rect(Rect2((Vector2(17.5, 25)), (rect_size / 1.5)), Color.DARK_GRAY, true) # Roof
	draw_rect(Rect2(front, Vector2(75, 25)), colour, true) # Hood
	draw_rect(Rect2(turret_pos, Vector2(25, 50)), Color.PINK, true)
